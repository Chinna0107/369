...
import { 
  ...
  PlayCircle, Bell, ArrowRight, Activity, Smile, Brain
} from 'lucide-react';
...
export function MeditationPage() {
  ...
  return (
    <div className="bg-[#f0f9f6] min-h-screen font-sans text-gray-800 pb-20 md:pb-0 overflow-hidden">
      <Header variant="back" title="Heartfulness Meditation" />
        ...
        <div className="max-w-4xl mx-auto text-center relative z-10">
          ...
          >
            ...
            <h1 className="text-4xl md:text-6xl font-serif text-[#0f4c3a] font-bold mb-6 leading-tight">
              Discover Inner <span className="text-teal-600">Peace</span>
            </h1>
            <p className="text-lg md:text-xl text-gray-600 max-w-2xl mx-auto mb-10 leading-relaxed">
              Take a few minutes every day for inner relaxation, mental calmness, and overall well-being. A simple practice for everyone.
            </p>
            ...
            >
              Begin Your Practice <ArrowRight className="w-5 h-5" />
            </button>
          </motion.div>
        </div>
      </div>
      ...
      <div className="max-w-[1200px] mx-auto px-6 md:px-12 space-y-24 pb-24">
        ...
        >
          ...
          <h2 className="text-2xl md:text-3xl font-serif font-bold text-[#0f4c3a] mb-6">Our Vision for Well-being</h2>
          <p className="text-lg text-gray-600 leading-relaxed mb-6">
            ULMGH-369 aims to bring together Commerce, Technology, Well-being, and Human Values on one platform. Heartfulness Meditation is intended to be an important well-being component of our platform, alongside our e-commerce ecosystem.
          </p>
          <p className="text-lg text-gray-600 leading-relaxed font-medium">
            This section is designed to be a peaceful, non-commercial space where you can explore simple guidance for beginners and experience the benefits of regular relaxation.
          </p>
        </motion.div>
        ...
        >
          ...
          <div className="relative z-10">
            <h2 className="text-3xl font-serif font-bold mb-4">Who Can Benefit?</h2>
            <p className="text-teal-100 text-lg mb-10 max-w-2xl mx-auto">
              Heartfulness is for people from all walks of life. No prior experience is needed.
            </p>
        ...
        <div id="practice-section" className="pt-10">
          <div className="text-center mb-12">
            <h2 className="text-3xl md:text-4xl font-serif font-bold text-[#0f4c3a] mb-4">Suggested Daily Practice</h2>
            <p className="text-lg text-gray-600 max-w-2xl mx-auto">
              We encourage you to spend 10–30 minutes a day for meditation, according to your individual comfort and availability.
            </p>
          </div>
        ...
        >
          <div className="flex items-start gap-4">
            ...
            <div>
              <h3 className="text-xl font-bold text-[#0f4c3a] mb-2">Build a Daily Habit</h3>
              <p className="text-teal-800/80">Set a gentle daily reminder to take time for yourself.</p>
            </div>
          </div>
          <button 
          ...
          >
            ...
            >
              ...
              <div className="relative z-10">
                ...
                <p className="text-teal-100/80 mb-10">{activeModal} Session</p>
                ...
                <p className="text-sm text-teal-100/60">
                  Audio/Video content integration coming soon. <br/> Close your eyes and gently focus on your heart.
                </p>
              </div>
            </motion.div>
          </motion.div>
