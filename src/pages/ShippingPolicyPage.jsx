      ...
      <div className="max-w-4xl mx-auto px-4 py-8 md:py-12">
        <div className="bg-white rounded-2xl shadow-xl border border-gray-100 p-6 md:p-10 space-y-8">
          ...
          <section>
            ...
            <p className="text-gray-600 text-sm leading-relaxed">
              ULMGH369 takes utmost care with packaging but is not directly liable for products damaged or lost during shipping. If you received your order damaged, please contact our support team immediately so we can assist you with a replacement or claim.
            </p>
          </section>
