    ...
    <div className="bg-[#f9f9f9] min-h-screen pb-20 md:pb-0 font-sans">
          ...
          <div className="max-w-[1400px] w-full mx-auto px-6 md:px-16">
            ...
            >
              ...
              <p className="text-gray-200 text-lg md:text-xl font-medium">
                Discover a world of premium traditional products and sacred essentials. Welcome to ULMGH369.
              </p>
            </motion.div>
          </div>
        </div>
      ...
      <div className="max-w-[1400px] mx-auto px-6 md:px-16 py-16 md:py-24">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-24 items-center mb-24">
          ...
          >
            ...
            <p className="text-lg text-gray-600 leading-relaxed">
              Welcome to <strong className="text-[#022A21] font-extrabold">ULMGH369</strong>. Our journey began with a simple yet powerful vision: to bridge the gap between authentic traditional products and seamless convenience.
            </p>
            <p className="text-lg text-gray-600 leading-relaxed">
        ...
        <div className="text-center max-w-3xl mx-auto mb-16">
          <h2 className="text-3xl md:text-4xl font-extrabold text-[#022A21] mb-4 font-serif">The ULMGH369 Promise</h2>
